...
const Container = styled.div`
  background: linear-gradient(90deg, rgba(56, 55, 65, 0.3) -60%, rgba(250, 250, 250, 0) 100%);
`;
              ...
              <figure className="overflow'hidden">
                <blockquote className="text-black-400 p-5 text-start text-lg">
                  ...
                  <p className="font'bold text'lg">
                    Jason was very knowledgeable and organized. I couldn’t have asked for a better outcome or
                    experience.
                    <br />
                    <br />– Maria V.
                  </p>
