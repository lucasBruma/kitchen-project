      ...
      <div className="relative flex flex-col items-start justify-center gap-8 px-6 py-16 text-white sm:px-32 xl:px-56">
        ...
        <div className="relative z-20 flex w-full flex-wrap justify-start gap-3 lg:flex-row xl:flex-nowrap xl:justify-between">
          ...
          <Link
            ...
            target="blank"
          >
            <img src="/houzz.png" alt="Houzz 2020" className="h-full w-full min-w-[250px] xl:w-[330px]" />
          </Link>
          <div>
            <img src="/nkba.png" alt="Houzz 2020" className="h-full w-full min-w-[250px] xl:w-[330px]" />
          </div>
          <div>
            <img src="/mcc-badge-4.png" alt="Houzz 2020" className="h-full w-full min-w-[250px] xl:w-[330px]" />
          </div>
        </div>
      </div>
    </main>
