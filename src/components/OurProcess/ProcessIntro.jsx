...
export const ProcessIntro = () => {
  return (
   <>
    <div className="flex w-full flex-col items-center justify-between gap-8 py-12 text-white sm:flex-row sm:items-start md:px-10 md:py-24 xl:px-56">

          <div className="flex max-w-[500px] flex-col items-center gap-2 px-6 sm:w-[100%] sm:items-start sm:px-0p-5">
            <h2 className="text-[2rem] text-red-main font-bold ">INITIAL SITE VISIT</h2>
            ...
            implications for your project. Please have a copy of your plat on hand and your wish list, and a general idea
            of this meeting s budget. We will provide information about Explore, including references, reprints of
