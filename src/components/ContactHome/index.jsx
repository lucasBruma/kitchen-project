...
export const ContactHome = () => {
  return (
    <div className="flex w-full flex-col items-center justify-between gap-12 bg-white p-12 text-primary-main md:flex-row md:px-32 md:py-24 xl:px-56">
      <div className="flex w-full flex-col items-center justify-between gap-24 rounded-lg p-12 shadow-lg md:flex-row md:items-start">
        ...
        <div className="flex flex-col gap-6 md:w-[50%]">
          <Image src="/vienna.webp" width={500} height={216} alt="Vienna business association" />
