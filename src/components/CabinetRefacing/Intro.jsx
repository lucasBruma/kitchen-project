...
export const Intro = () => {
  return (
    <>
      <div className="flex flex-col gap-14 pb-12 text-start md:pb-20">
        ...
        <div className="flex flex-col items-center justify-around gap-8 lg:flex-row lg:gap-0">
          ...
          <div className="flex flex-col gap-8 text-lg lg:w-1/2">
            <div className="">
              {" "}
              When you replace kitchen cabinets, you’ll obviously remove cabinets from your kitchen’s walls, throw them
              out, and put new ones in their place.{" "}
